...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            //$model->setStoreView($store_ids);
            $model->setData($data);
            try {
                $model->save();                               
                $this->messageManager->addSuccess(__('The Careerprocess has been saved.'));
                ...
                $this->messageManager->addException($e, __('Something went wrong while saving the Careerprocess.'));
            }
