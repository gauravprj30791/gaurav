...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Digital_Careerprocess::Careerprocess')
            ->addBreadcrumb(__('Digital Careerprocess'), __('Digital Careerprocess'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('careerprocess', $model);
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Item') : __('New Careerprocess'),
            $id ? __('Edit Item') : __('New Careerprocess')
        );        
        $resultPage->getConfig()->getTitle()->prepend($id ? __('Edit Careerprocess') : __('New Careerprocess'));
